...
describe ParentsController do
  ...
  let(:valid_attributes) { { "parentname" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved parent as @parent" do
        ...
        post :create, {:parent => { "parentname" => "invalid value" }}, valid_session
        assigns(:parent).should be_a_new(Parent)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested parent" do
        ...
        Parent.any_instance.should_receive(:update).with({ "parentname" => "MyString" })
        put :update, {:id => parent.to_param, :parent => { "parentname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the parent as @parent" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Parent.any_instance.stub(:save).and_return(false)
        put :update, {:id => parent.to_param, :parent => { "parentname" => "invalid value" }}, valid_session
        assigns(:parent).should eq(parent)
      end

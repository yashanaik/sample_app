...
describe CustomersController do
  ...
  let(:valid_attributes) { { "rstid" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved customer as @customer" do
        ...
        post :create, {:customer => { "rstid" => "invalid value" }}, valid_session
        assigns(:customer).should be_a_new(Customer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested customer" do
        ...
        Customer.any_instance.should_receive(:update).with({ "rstid" => "MyString" })
        put :update, {:id => customer.to_param, :customer => { "rstid" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the customer as @customer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Customer.any_instance.stub(:save).and_return(false)
        put :update, {:id => customer.to_param, :customer => { "rstid" => "invalid value" }}, valid_session
        assigns(:customer).should eq(customer)
      end
